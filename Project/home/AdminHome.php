...
<body>
	...
	<section class="addform2 cf">
		...
		<section class="addform cf">
			...
			<form name="query" action="userUtil/delete_professor.php" method="post" accept-charset="utf-8">
				<ul>				
					<li>	
						<?php
		...
		<section class="addform cf">
			<h3>Delete Course</h3>
			<form name="query" action="userUtil/delete_course.php" method="post" accept-charset="utf-8">
				<ul>				
					<li>	
						<?php
							include '../include/connectPRdata.php';
